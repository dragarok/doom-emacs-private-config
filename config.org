...
(setq elfeed-score-file "~/Nextcloud/elfeed/elfeed-score.el")

(setq! citar-bibliography '((concat org-directory "references.bib")))
(setq! citar-notes-paths '(org-roam-directory))
(setq! citar-library-paths '(("~/Nextcloud/Ref_Library/")))

(setq org-directory "~/Nextcloud/")
(setq org-roam-directory "~/Nextcloud/notes")
(setq org-agenda-directory "~/Nextcloud/agenda/")
(setq org-templates-directory "~/Nextcloud/templates/")
(setq org-lookbacks-directory "~/Nextcloud/lookbacks/")
...
#+begin_src elisp
(setq rmh-elfeed-org-files (list "~/Nextcloud/elfeed/elfeed.org"))
#+end_src
...
(defun copy-link-for-kindle ()
  (interactive)
  (elfeed-show-yank)
  (wallabag-add-entry (car kill-ring) "elfeed")
  )
#+end_src


*** Get twitter thread to threader and to wallabag

#+begin_src emacs-lisp
(defun add-thread-to-wallabag()
  (interactive)
  (wallabag-add-entry
   (concat "https://threadreaderapp.com/search?q=" (url-hexify-string (car kill-ring))) "twitterthread"))
#+end_src
...
(after! org (add-to-list 'org-capture-templates
                         '("rw" "Weekly Review" entry (file+olp+datetree (concat org-lookbacks-directory "weeklyreview.org"))
                           (file (concat org-templates-directory "weeklyreviewtemplate.org")) :tree-type week)))

(after! org (add-to-list 'org-capture-templates
                         '("rm" "Monthly Review" entry (file+olp+datetree (concat org-lookbacks-directory "monthlyreview.org"))
                           (file (concat org-templates-directory "monthlyreviewtemplate.org")) :tree-type month)))

(after! org (add-to-list 'org-capture-templates
                         '("rq" "Quarterly Review" entry (file+olp+datetree  (concat org-lookbacks-directory "quarterlyreview.org"))
                           (file (concat org-templates-directory "monthlyreviewtemplate.org")) :tree-type month)))

(after! org (add-to-list 'org-capture-templates
                         '("rd" "Daily Review" entry (file+olp+datetree  (concat org-lookbacks-directory "dailyreview.org"))
...
")
          ...
          ("l" "Literature Notes " plain "%?"
           :if-new (file+head "ln_${slug}.org"
                              "#+TITLE: ${title}
,#+CREATED_DATE: %T
,#+filetags: :%^{definition|theory|course|video|article|library|subject|chapter|research}:%^G
,#+REF_URL: %^{URL}
")
           :unnarrowed t)

          ("c" "Creative Writing" plain "%?"
           :if-new (file+head "cw_${slug}.org"
                              "#+TITLE: ${title}
,#+CREATED_DATE: %T
,#+filetags: :creativewriting:
")
           :unnarrowed t)
          ...
          ("p" "Person" plain "%?"
           :if-new (file+head "per_${slug}.org"
                              "#+TITLE: ${title}
,#+CREATED_DATE: %T
,#+filetags: :person:
")

...
#+END_SRC
** Evil Keybinding to do o or 0 on normal mode
#+begin_src elisp
...
(setq doom-font (font-spec :family "SpaceMono Nerd Font Mono" :size 18)
      doom-variable-pitch-font (font-spec :family "OverpassMono Nerd Font" :size 21)
      ...
      doom-big-font (font-spec :family "SpaceMono Nerd Font" :size 26))

...
(if IS-MAC
    (setq doom-font (font-spec :family "Iosevka Nerd Font" :size 16)
          doom-variable-pitch-font (font-spec :family "Linux Libertine" :size 16)
...
(after! org
  ...
  (setq org-time-budgets '((:title "EHP" :match "+work" :budget "40:00" :blocks (workday week))
                           ...
                           (:title "Exercise" :match "+personal" :budget "0:20" :blocks (day))
                           (:title "Coding" :match "+coding" :budget "40:00" :blocks (nil week))
                           (:title "Reading" :match "+book" :budget "3:00" :blocks (nil week))
                           (:title "Yollo" :match "+personal+coding" :budget "20:00" :blocks (nil week))
                           ))
  )
#+END_SRC
*** Agenda View

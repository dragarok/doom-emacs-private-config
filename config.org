...
#+END_SRC
** Line Numbers and Writeroom Spacing
...
#+END_SRC
** Show dired cleaner without details
#+begin_src elisp
...
** Restore and Load Window Layouts
#+begin_src elisp
...
** Autosync and Conflict Resolution
For resolving conflicts when syncing with phone. Conflict resolution of org files on phone.
#+begin_src elisp
...
*** Split and choose a buffer in the same workspace
#+begin_src elisp
;;;###autoload
...
#+END_SRC
** Jethro Org Roam Specifics Config
...
(after! org
  ...
  (add-to-list 'org-global-properties
               '("Effort_ALL". "0:05 0:10 0:15 0:30 1:00 2:00"))
  ...
  (setq org-todo-keyword-faces
        '(("TODO" :foreground "DeepSkyBlue4" :weight bold)
          ...
          ("REREADING" :foreground "DimGray" :weight bold)
          ("SUMMARISING" :foreground "firebrick" :weight bold)

          ;; MEETING
          ;; ("MEETING" :foreground "DeepSkyBlue4" :weight bold)
        ...
        (setq org-todo-keywords
              '((sequence "TODO(t)" "NEXT(n)" "ACTIVE(a)" "WAITING(w)" "|" "DONE(d!/!)")
                ;; (sequence "MEETING(m)" "ACTIVE(a)" "|" "CANCELED(c@/!)")
        ...
        (setq org-tag-alist '(
                              ...
                              ;; Achievement goal vs habit goal
                              ;; If your achievement goal is to “Loose weight”,
                              ;; then your habit item will have a title of “Jogging 30 mins a day”,
                              ;; scheduled “every 7AM” in the morning, with a location of “At the park”.
                              ;; What, when, and where
                              (:startgroup . nil)
                              ;; For results based
                              ("habit". ?h)
                              ;; For achievement based with deadline
                              ("goal" . ?g)
                              ;; re-evaluate goals and make adjustments
                              ("refinement" . ?r)
                              (:endgroup . nil)
...
#+end_src
*** Org Roam v2 Frame Title and Backlink
#+begin_src elisp
...
#+begin_src emacs-lisp
(after! org (add-to-list 'org-capture-templates
             '("$1" "$2" entry(file+olp+datetree"~/Dropbox/org/notes/20220320153833-workout_log.org" "Workout Log")

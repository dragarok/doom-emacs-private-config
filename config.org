...
(after! org
  ...
  (define-key org-mode-map (kbd "s-=") 'org-superscript-region-or-point)
  ...
  (define-key org-mode-map (kbd "s-p") 'org-latex-math-region-or-point)
)
#+END_SRC
** Ease in projects
#+BEGIN_SRC elisp
...
#+END_SRC
** Jupyter Org Blocks No native compile

...
(use-package! org-modern
  ...
  (setq org-modern-priority-faces '(
                                    (?A . (:foreground "OrangeRed3" :background "" :weight bold))
                                    (?B . (:foreground "red" :background "" :weight bold))
                                    (?C . (:foreground "tomato" :background "" :weight bold ))
                                    (?D . (:foreground "DarkCyan" :background "" :weight bold ))
                                    (?E . (:foreground "SeaGreen1" :background "" :weight bold ))
                                    (?F . (:foreground "green" :background "" :weight bold ))))
  (global-org-modern-mode)
  )
#+end_src

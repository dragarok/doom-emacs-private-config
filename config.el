...
(load-theme 'doom-gruvbox-light 'noconfirm)
...
(after! org
  ...
  (custom-set-faces!
    ...
    '(outline-3 :inherit variable-pitch :slant italic :weight bold :height 1.3)
    ...
    '(org-level-3 :inherit variable-pitch :slant italic :weight bold :height 1.3)
    ...
    '(org-document-title :height 1.3 :weight normal :underline nil)
    '(org-document-info :height 1.3 :slant italic)
...
Version 2015-07-30"
  ...
  (let (-sort-by -hidden -arg)
    (setq -sort-by (ivy-read "Sort by:" '( "Date" "Size" "Name" "Dir" "Date Asc" "Name Desc" "Size Asc")))
